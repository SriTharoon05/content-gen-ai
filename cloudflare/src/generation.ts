...
Write 20–25 sequential visual beats, up to 30 only if context needs them. 130–180 spoken words, absolute maximum 205. Natural fluent complete thoughts, no robotic fragments. An expressive human voice, contractions, varied rhythm. The first beat must be at most 16 words and give a specific reason to watch. Facts/science use a curiosity question or concrete puzzle, not generic hype. Fiction starts in an intriguing scene, not forced 'do you know'. Empty speaker fields.`,validateScript);
